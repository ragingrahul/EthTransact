...
const Input=({placeholder,name,type,value,handleChange})=>{
    ...
    return(
        <input
            ...
            className={`my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm ${styles.blueglassmorphism} `}
        />
    )
}
        ...
        <div className="flex flex-col w-full justify-center items-center">
            <div className="flex flew-col items-start justify-between md:p-20 py-12 px-4">
                ...
                <div className="flex flex-1 flex-col justify-start items-center w-full md:mt-0 mt-10">
                    ...
                    <div className={`p-5 sm:w96 w-full flex flex-col justify-start items-center ${styles.blueglassmorphism}`}>
